    ...
    <div>
      ...
      <form action={saveChurch} className="max-w-xl space-y-4">
        ...
        <p className="-mt-2 text-xs text-slate-500">
          Powers the pin on the <a href="/map" className="underline">Church Map</a>. To find these:
          open Google Maps, find the church, right-click the exact spot, and click the coordinates
          that appear (e.g. "-17.7404, 168.3219") to copy them — paste the first number into
